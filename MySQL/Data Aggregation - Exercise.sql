...
# Exercise 12 Employees Minimum Salaries
SELECT 
...
# Exercise 13 Employees Average Salaries
...
# Exercise 14 Employees Maximum Salaries
SELECT 
...
# Exercise 15 Employees Count Salaries
SELECT 
    COUNT(`employee_id`)
FROM
    `employees`
...
# Exercise 16 3rd Highest Salary
SELECT DISTINCT
    `department_id`,
    (SELECT DISTINCT
            `salary`
...
# Exercise 18 Departments Total Salaries
SELECT 
