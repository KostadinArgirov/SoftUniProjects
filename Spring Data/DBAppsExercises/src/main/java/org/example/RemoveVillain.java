...
public class RemoveVillain {
    ...
    private static final String GET_MINION_COUNT_BY_VILLAINS_ID = "SELECT count(DISTINCT mv.minion_id) m_count FROM minions_villains mv WHERE mv.villain_id = ?";
    private static final String COLUMN_LABEL_MINION_COUNT = "m_count";
    private static final String DELETE_MINION_VILLAIN_BY_VILLAIN_ID = "DELETE FROM minions_villains mv WHERE mv.villain_id = ?";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        try (PreparedStatement deleteMinionStatement = connection.prepareStatement(DELETE_MINION_VILLAIN_BY_VILLAIN_ID);
