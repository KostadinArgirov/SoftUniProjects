package advanced.definingClassesExercises.FamilyTree;

import java.util.*;

import static advanced.definingClassesExercises.FamilyTree.Person.findPerson;
import static advanced.definingClassesExercises.FamilyTree.Person.getFamilyTreeFor;
